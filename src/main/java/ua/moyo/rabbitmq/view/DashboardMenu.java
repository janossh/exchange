...
public final class DashboardMenu extends CustomComponent {
    ...
    private Component buildTitle() {
        Label logo = new Label("MoYo", ContentMode.HTML);
    ...
    private UserDashboard getCurrentUser() {
        return (UserDashboard) VaadinSession.getCurrent().getAttribute(
    ...
    private Component buildUserMenu() {
        ...
        final UserDashboard user = getCurrentUser();
    ...
    private Component buildToggleButton() {
        ...
        valoMenuToggleButton.setIcon(VaadinIcons.LIST); //FontAwesome.LIST
    ...
    public void updateUserName(final DashboardEvent.ProfileUpdatedEvent event) {
        UserDashboard user = getCurrentUser();
